...
/*   Updated: 2023/05/07 00:36:40 by martiper         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t		ft_def_printf_putaddress(void *n, t_ft_printf_flags flags);
...
size_t		ft_def_printf_puthexadecimal(unsigned long long n, int upper,
				t_ft_printf_flags flags);
size_t		ft_def_printf_putfloat(double n,
				t_ft_printf_flags flags);
#endif
